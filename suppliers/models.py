...
# ordenado por nome, poderia ser -name, para ordem invertida, ou  created_at, para ordem por entrada "-" para inverter
    ...
    def __str__(self):
        return self.name
# aqui o __str__ garante o reotno da pesquisa em nome listado e não em um número do bd garantindo a fácil visulização quando consultado Create your models here.
